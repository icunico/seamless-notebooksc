...
def load_pickle(path):
	try:
		...
		# Python 3.6 cannot read protocol 5 pickles. If pickle5 is available,
		# retry with it; otherwise raise a clear message.
...
# Keep a square plotting panel like 2A, even with different numeric ranges.
ax.set_box_aspect(1)
ax.tick_params(axis="both", which="major", labelsize=24)

output_dir = Path(__file__).resolve().parent / "PLOT_PAPERFINALI"
output_dir.mkdir(parents=True, exist_ok=True)
output_file_png = output_dir / "Result1E_P1P2_paper.png"
output_file_pdf = output_dir / "Result1E_P1P2_paper.pdf"
