...
def build_plot(input_pickle, output_stem):
	new_dict = load_pickle(input_pickle)
	y = new_dict["Y"]
	x = new_dict["X"]
	...
	output_file_png = output_dir / f"{output_stem}.png"
	output_file_pdf = output_dir / f"{output_stem}.pdf"
...
build_plot("fussmann3B_P1P2C1legP2.pickle", "Result3B_P1P2C1legP2_paper")
